...
async function loadMoviesData() {
  try {
    const response = await fetch('../data/dataEn.json');
      ...
      <div class="movie-info">
        ...
        <div class="combo-menu">
          ...
          <select class="menu-selector" data-menu-index="${index + 1}">
            ...
            <option value="single">Single - ${movie.menu.single.newPrice}</option>
            <option value="double">Double - ${movie.menu.double.newPrice}</option>
          </select>
