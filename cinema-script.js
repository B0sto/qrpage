      ...
      <div class="movie-info">
        ...
        <div class="combo-menu">
          ...
          <select class="menu-selector" data-menu-index="${index + 1}">
            <option value="">აირჩიეთ მენიუ</option>
            <option value="single">ერთ კაციანი - ${movie.menu.single.newPrice}</option>
            <option value="double">ორ კაციანი - ${movie.menu.double.newPrice}</option>
          </select>
